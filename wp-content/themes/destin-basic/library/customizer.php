...
function bavotasan_theme_options() {
	//delete_option( 'destin_basic_theme_options' );
	if ( ! $options = get_option( 'destin_basic_theme_options' ) ) {
		$options = array(
			'width' => '1170',
			'layout' => 'right',
			'primary' => 'col-md-9',
		);
		add_option( 'destin_basic_theme_options', $options );
	}
...
class Bavotasan_Customizer {
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'destin_theme_options[width]', array(
		...
		$wp_customize->add_control( 'bavotasan_width', array(
			...
			'settings' => 'destin_theme_options[width]',
			'priority' => 10,
			'type' => 'select',
			'choices' => array(
		...
		$wp_customize->add_setting( 'destin_theme_options[primary]', array(
		...
		$wp_customize->add_control( 'bavotasan_primary_column', array(
			...
			'section' => 'bavotasan_layout',
			'settings' => 'destin_theme_options[primary]',
			'priority' => 15,
			'type' => 'select',
			'choices' => $choices,
		) );

		$wp_customize->add_setting( 'destin_theme_options[layout]', array(
		...
		$wp_customize->add_control( new Bavotasan_Post_Layout_Control( $wp_customize, 'layout', array(
			...
			'section' => 'bavotasan_layout',
			'settings' => 'destin_theme_options[layout]',
			'priority' => 25,
