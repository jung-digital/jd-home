...
if ( ! function_exists( 'urbanbold_theme_customizer' ) ) :
  function urbanbold_theme_customizer( $wp_customize ) {
    ...
    $wp_customize->add_section( 'urbanbold_author_bio_section' , array(
      'title'       => __( 'Disable Author Bio', 'urban-bold' ),
      'priority'    => 35,
      'description' => __( 'Option to disable the author bio in the posts.', 'urban-bold' ),
    ) );
    ...
    $wp_customize->add_control('author_bio', array(
      ...
      'section' => 'urbanbold_author_bio_section',
      'type' => 'checkbox',
    ));

   /* Featured Image in Posts */
    $wp_customize->add_section( 'urbanbold_image_post_section' , array(
      'title'       => __( 'Show Featured Image in Posts', 'urban-bold' ),
      'priority'    => 36,
      'description' => __( 'Option to Show Featured Image in Posts.', 'urban-bold' ),
    ) );
    ...
    $wp_customize->add_control('image_post', array(
      ...
      'section' => 'urbanbold_image_post_section',
      'type' => 'checkbox',
    ));

    /* Featured Image in Page */
    $wp_customize->add_section( 'urbanbold_image_page_section' , array(
      'title'       => __( 'Show Featured Image in Page', 'urban-bold' ),
      'priority'    => 37,
      'description' => __( 'Option to Show Featured Image in Page.', 'urban-bold' ),
    ) );
